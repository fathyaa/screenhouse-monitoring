...
-- Isi: registry + threshold_snapshots 3 screenhouse inti, 4 sensor node,
...
--
-- 30+ screenhouse peta: jalankan `npm run import` lalu `npm run seed:map`
-- di database/scripts (lihat database/README.md).
-- =========================================
...
-- ─── 2. Threshold snapshots (mirror thresholds dari App DB) ───
